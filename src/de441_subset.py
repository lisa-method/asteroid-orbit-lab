"""Explicit geometric center chaining over a local DE441 Type-2 subset."""
...
from prepare_apophis_spk import prepare
...
class DE441Subset:
    ...
    def ephemeris(self, target: int, center: int = 10):
        return DE441Ephemeris(self, target, center)


class DE441Ephemeris:
    def __init__(self, backend: DE441Subset, target: int, center: int):
